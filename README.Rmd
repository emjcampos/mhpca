...
Data can be simulated following the simulation low noise, dense set-up from the supplementary materials using the following function: 
```{r simulate data}
...
Using simulated data, we can calculate the errors of each model component and display in a table, similar to the ones provided in the paper: 
```{r error-table}
...
and for tests between groups, we test the null hypothesis $H_0: \eta_{d_1j_1}(r, t) - \eta_{d_1j_2} = \eta_{d_2j_1} - \eta_{d_2j_2}$ with the following function
